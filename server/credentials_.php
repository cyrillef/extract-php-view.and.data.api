...
$config =array (
	'credentials' => array (
		...
		'client_id' => getenv ('CONSUMERKEY') ? : '<replace with your consumer key>',
		'client_secret' => getenv ('CONSUMERSECRET') ? : '<replace with your consumer secret>',
	...
	'MAILJET2' => getenv ('MAILJET2') ? : '<replace with your mailjet consumer secret>'
) ;
